...
- Comment the value in both context.xml files in (cd webapps/manager/META-INF/) (cd /webapps/host-manager/META-INF)
...
- In the test stage, provide the copy line of the SonarQube command
